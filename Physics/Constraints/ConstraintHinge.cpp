...
/*
================================
ConstraintHinge::PreSolve
================================
*/
void ConstraintHinge::PreSolve( const float deltaSecond ) {
...
/*
================================
ConstraintHinge::Solve
================================
*/
void ConstraintHinge::Solve() {
...
/*
================================
ConstraintHinge::PostSolve
================================
*/
void ConstraintHinge::PostSolve() {
...
/*
================================
ConstraintHingeLimited::PreSolve
================================
*/
void ConstraintHingeLimited::PreSolve( const float deltaSecond ) {
	// Get the world space position of the hinge from anchorA's orientation
	const Vec3 worldAnchorA = m_bodyA->BodySpaceToWorldSpace(m_anchorA);
	...
	const float relativeAngleInDegree = 2.0f * asinf(currentRelativeOrientation.xyz().Dot(hingeAxis)) * 180.0f / pi;

	// Check if there's an angle violation
	m_isAngleViolated = false;
	const float angleLimit = 45.0f;
	if (relativeAngleInDegree > angleLimit)
		m_isAngleViolated = true;
	if (relativeAngleInDegree < -angleLimit)
		m_isAngleViolated = true;
	m_relativeAngle = relativeAngleInDegree;
	...
	if (m_isAngleViolated) {
		...
		tempVector = MatA * Vec4(0, hingeAxis.x, hingeAxis.y, hingeAxis.z);
		J2 = Vec3(tempVector[ONE + 0], tempVector[ONE + 1], tempVector[ONE + 2]);
		...
		tempVector = MatB * Vec4(0, hingeAxis.x, hingeAxis.y, hingeAxis.z);
		J4 = Vec3(tempVector[ONE + 0], tempVector[ONE + 1], tempVector[ONE + 2]);
...
/*
================================
ConstraintHingeLimited::Solve
================================
*/
void ConstraintHingeLimited::Solve() {
	const MatMN JacobianTranspose = m_Jacobian.Transpose();
...
/*
================================
ConstraintHingeLimited::PostSolve
================================
*/
void ConstraintHingeLimited::PostSolve() {
	// Limit the warm starting to reasonable limits
	for (int currentIndex = 0; currentIndex < m_cachedLagrange.N; ++currentIndex) {
		if (currentIndex > 0)
			m_cachedLagrange[currentIndex] = 0.0f;
